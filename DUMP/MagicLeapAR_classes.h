...
struct ULuminARSessionFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void StartLuminARSession(struct UObject* WorldContextObject, struct FLatentActionInfo LatentInfo, struct ULuminARSessionConfig* Configuration); // Function MagicLeapAR.LuminARSessionFunctionLibrary.StartLuminARSession // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x1277520
};
...
struct ULuminARFrameFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool LuminARLineTrace(struct UObject* WorldContextObject, struct FVector2D ScreenPosition, struct TSet<enum class ELuminARLineTraceChannel> TraceChannels, struct TArray<struct FARTraceResult> OutHitResults); // Function MagicLeapAR.LuminARFrameFunctionLibrary.LuminARLineTrace // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x1277260
	enum class ELuminARTrackingState GetTrackingState(); // Function MagicLeapAR.LuminARFrameFunctionLibrary.GetTrackingState // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x1277210
};
...
struct ULuminARImageTrackingFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct ULuminARCandidateImage* AddLuminRuntimeCandidateImageEx(struct UARSessionConfig* SessionConfig, struct UTexture2D* CandidateTexture, struct FString FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary, enum class EMagicLeapImageTargetOrientation InAxisOrientation); // Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImageEx // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x1276e90
	struct ULuminARCandidateImage* AddLuminRuntimeCandidateImage(struct UARSessionConfig* SessionConfig, struct UTexture2D* CandidateTexture, struct FString FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary); // Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImage // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x1276c60
};
...
struct ULuminARLightEstimate : UARBasicLightEstimate {
	...
	struct TArray<float> GetAmbientIntensityNits(); // Function MagicLeapAR.LuminARLightEstimate.GetAmbientIntensityNits // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1277110
};
...
struct ULuminARCandidateImage : UARCandidateImage {
	...
	bool GetUseUnreliablePose(); // Function MagicLeapAR.LuminARCandidateImage.GetUseUnreliablePose // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1277240
	bool GetImageIsStationary(); // Function MagicLeapAR.LuminARCandidateImage.GetImageIsStationary // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x12771f0
	enum class EMagicLeapImageTargetOrientation GetAxisOrientation(); // Function MagicLeapAR.LuminARCandidateImage.GetAxisOrientation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x12771d0
};
