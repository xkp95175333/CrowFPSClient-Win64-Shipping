...
struct UBakeMeshAttributeMapsToolProperties : UInteractiveToolPropertySet {
	...
	struct FString UVLayer; // 0x68(0x10)
	struct TArray<struct FString> UVLayerNamesList; // 0x78(0x10)
	bool bUseWorldSpace; // 0x88(0x01)
	char pad_89[0x7]; // 0x89(0x07)
	struct UTexture2D* Result; // 0x90(0x08)

	struct TArray<struct FString> GetUVLayerNamesFunc(); // Function MeshModelingTools.BakeMeshAttributeMapsToolProperties.GetUVLayerNamesFunc // (Final|Native|Public) // @ game+0xe78e30
};
...
struct UBakedOcclusionMapToolProperties : UInteractiveToolPropertySet {
	int32_t OcclusionRays; // 0x60(0x04)
	float MaxDistance; // 0x64(0x04)
	bool bGaussianBlur; // 0x68(0x01)
	char pad_69[0x3]; // 0x69(0x03)
	float BlurRadius; // 0x6c(0x04)
	float BiasAngle; // 0x70(0x04)
...
struct UBakeMeshAttributeMapsTool : UMultiSelectionTool {
	...
	char pad_D8[0x358]; // 0xd8(0x358)
	struct UTexture2D* CachedNormalMap; // 0x430(0x08)
	char pad_438[0x18]; // 0x438(0x18)
	struct UTexture2D* CachedOcclusionMap; // 0x450(0x08)
	char pad_458[0x28]; // 0x458(0x28)
	struct UTexture2D* CachedCurvatureMap; // 0x480(0x08)
	char pad_488[0x10]; // 0x488(0x10)
	struct UTexture2D* CachedMeshPropertyMap; // 0x498(0x08)
	char pad_4A0[0x10]; // 0x4a0(0x10)
	struct UTexture2D* CachedTexture2DImageMap; // 0x4b0(0x08)
	struct UTexture2D* EmptyNormalMap; // 0x4b8(0x08)
	struct UTexture2D* EmptyColorMapBlack; // 0x4c0(0x08)
	struct UTexture2D* EmptyColorMapWhite; // 0x4c8(0x08)
};
...
struct UDeformMeshPolygonsTool : UMeshSurfacePointTool {
	...
	char pad_D8[0x1218]; // 0xd8(0x1218)
};
...
struct UDisplaceMeshCommonProperties : UInteractiveToolPropertySet {
	...
	struct TArray<struct FString> GetWeightMapsFunc(); // Function MeshModelingTools.DisplaceMeshCommonProperties.GetWeightMapsFunc // (Final|Native|Public) // @ game+0xe78e30
};
...
struct UDynamicMeshBrushTool : UBaseBrushTool {
	struct UPreviewMesh* PreviewMesh; // 0x1c0(0x08)
...
struct UDynamicMeshSculptTool : UMeshSurfacePointTool {
	...
	char pad_158[0xaf8]; // 0x158(0xaf8)
	struct UTransformGizmo* PlaneTransformGizmo; // 0xc50(0x08)
	struct UTransformProxy* PlaneTransformProxy; // 0xc58(0x08)
...
struct UPolyEditCommonProperties : UInteractiveToolPropertySet {
	...
	bool bSelectEdgeLoops; // 0x61(0x01)
	char pad_62[0x2]; // 0x62(0x02)
...
struct UEditMeshPolygonsToolActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Retriangulate(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Retriangulate // (Final|Native|Public) // @ game+0xe82190
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions.RecalcNormals // (Final|Native|Public) // @ game+0xe82170
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Outset // (Final|Native|Public) // @ game+0xe82110
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Offset // (Final|Native|Public) // @ game+0xe820f0
	void Merge(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Merge // (Final|Native|Public) // @ game+0xe820d0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Inset // (Final|Native|Public) // @ game+0xe82090
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Flip // (Final|Native|Public) // @ game+0xe82030
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Extrude // (Final|Native|Public) // @ game+0xe81ff0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Disconnect // (Final|Native|Public) // @ game+0xe81fd0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Delete // (Final|Native|Public) // @ game+0xe81fb0
	void Decompose(); // Function MeshModelingTools.EditMeshPolygonsToolActions.Decompose // (Final|Native|Public) // @ game+0xe81f90
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions.CutFaces // (Final|Native|Public) // @ game+0xe81f70
};
...
struct UEditMeshPolygonsToolActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void RecalcNormals(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.RecalcNormals // (Final|Native|Public) // @ game+0xe82170
	void Poke(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Poke // (Final|Native|Public) // @ game+0xe82150
	void Outset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Outset // (Final|Native|Public) // @ game+0xe82110
	void Offset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Offset // (Final|Native|Public) // @ game+0xe820f0
	void Inset(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Inset // (Final|Native|Public) // @ game+0xe82090
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Flip // (Final|Native|Public) // @ game+0xe82030
	void Extrude(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Extrude // (Final|Native|Public) // @ game+0xe81ff0
	void Disconnect(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Disconnect // (Final|Native|Public) // @ game+0xe81fd0
	void Delete(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.Delete // (Final|Native|Public) // @ game+0xe81fb0
	void CutFaces(); // Function MeshModelingTools.EditMeshPolygonsToolActions_Triangles.CutFaces // (Final|Native|Public) // @ game+0xe81f70
};
...
struct UEditMeshPolygonsToolUVActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void PlanarProjection(); // Function MeshModelingTools.EditMeshPolygonsToolUVActions.PlanarProjection // (Final|Native|Public) // @ game+0xe82130
};
...
struct UEditMeshPolygonsToolEdgeActions : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Weld // (Final|Native|Public) // @ game+0xe82250
	void Straighten(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.Straighten // (Final|Native|Public) // @ game+0xe82210
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions.FillHole // (Final|Native|Public) // @ game+0xe82010
};
...
struct UEditMeshPolygonsToolEdgeActions_Triangles : UEditMeshPolygonsToolActionPropertySet {
	...
	void Weld(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Weld // (Final|Native|Public) // @ game+0xe82250
	void Split(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Split // (Final|Native|Public) // @ game+0xe821f0
	void Flip(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Flip // (Final|Native|Public) // @ game+0xe82050
	void FillHole(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.FillHole // (Final|Native|Public) // @ game+0xe82010
	void Collapse(); // Function MeshModelingTools.EditMeshPolygonsToolEdgeActions_Triangles.Collapse // (Final|Native|Public) // @ game+0xe81f50
};
...
struct UEditPivotToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Top(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Top // (Final|Native|Public) // @ game+0xe82230
	void Right(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Right // (Final|Native|Public) // @ game+0xe821b0
	void Left(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Left // (Final|Native|Public) // @ game+0xe820b0
	void Front(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Front // (Final|Native|Public) // @ game+0xe82070
	void Center(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Center // (Final|Native|Public) // @ game+0xe81f10
	void Bottom(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Bottom // (Final|Native|Public) // @ game+0xe81ef0
	void Back(); // Function MeshModelingTools.EditPivotToolActionPropertySet.Back // (Final|Native|Public) // @ game+0xe81ed0
};
...
struct UHoleFillToolActions : UInteractiveToolPropertySet {
	...
	void SelectAll(); // Function MeshModelingTools.HoleFillToolActions.SelectAll // (Final|Native|Public) // @ game+0xe821d0
	void Clear(); // Function MeshModelingTools.HoleFillToolActions.Clear // (Final|Native|Public) // @ game+0xe81f30
};
...
// Size: 0x630 (Inherited: 0x200)
struct UMeshAttributePaintTool : UDynamicMeshBrushTool {
	struct UMeshAttributePaintToolProperties* AttribProps; // 0x200(0x08)
	char pad_208[0x428]; // 0x208(0x428)
};
...
struct UMeshSelectionEditActions : UMeshSelectionToolActionPropertySet {
	...
	void Shrink(); // Function MeshModelingTools.MeshSelectionEditActions.Shrink // (Final|Native|Public) // @ game+0xe872c0
	void SelectLargestComponentByTriCount(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByTriCount // (Final|Native|Public) // @ game+0xe87280
	void SelectLargestComponentByArea(); // Function MeshModelingTools.MeshSelectionEditActions.SelectLargestComponentByArea // (Final|Native|Public) // @ game+0xe87260
	void SelectAll(); // Function MeshModelingTools.MeshSelectionEditActions.SelectAll // (Final|Native|Public) // @ game+0xe87240
	void OptimizeSelection(); // Function MeshModelingTools.MeshSelectionEditActions.OptimizeSelection // (Final|Native|Public) // @ game+0xe87220
	void Invert(); // Function MeshModelingTools.MeshSelectionEditActions.Invert // (Final|Native|Public) // @ game+0xe87200
	void Grow(); // Function MeshModelingTools.MeshSelectionEditActions.Grow // (Final|Native|Public) // @ game+0xe871e0
	void ExpandToConnected(); // Function MeshModelingTools.MeshSelectionEditActions.ExpandToConnected // (Final|Native|Public) // @ game+0xe871a0
	void Clear(); // Function MeshModelingTools.MeshSelectionEditActions.Clear // (Final|Native|Public) // @ game+0xe87120
};
...
struct UMeshSelectionMeshEditActions : UMeshSelectionToolActionPropertySet {
	...
	void SeparateTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.SeparateTriangles // (Final|Native|Public) // @ game+0xe872a0
	void FlipNormals(); // Function MeshModelingTools.MeshSelectionMeshEditActions.FlipNormals // (Final|Native|Public) // @ game+0xe871c0
	void DisconnectTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DisconnectTriangles // (Final|Native|Public) // @ game+0xe87180
	void DeleteTriangles(); // Function MeshModelingTools.MeshSelectionMeshEditActions.DeleteTriangles // (Final|Native|Public) // @ game+0xe87160
	void CreatePolygroup(); // Function MeshModelingTools.MeshSelectionMeshEditActions.CreatePolygroup // (Final|Native|Public) // @ game+0xe87140
};
...
// Size: 0x4a0 (Inherited: 0x200)
struct UMeshSelectionTool : UDynamicMeshBrushTool {
	struct UMeshSelectionToolProperties* SelectionProps; // 0x200(0x08)
	struct UMeshSelectionEditActions* SelectionActions; // 0x208(0x08)
	struct UMeshSelectionToolActionPropertySet* EditActions; // 0x210(0x08)
	struct UMeshSelectionSet* Selection; // 0x218(0x08)
	struct TArray<struct AActor*> SpawnedActors; // 0x220(0x10)
	char pad_230[0x270]; // 0x230(0x270)
};
...
struct UMirrorToolActionPropertySet : UInteractiveToolPropertySet {
	...
	void Up(); // Function MeshModelingTools.MirrorToolActionPropertySet.Up // (Final|Native|Public) // @ game+0xe8c0c0
	void ShiftToCenter(); // Function MeshModelingTools.MirrorToolActionPropertySet.ShiftToCenter // (Final|Native|Public) // @ game+0xe8c0a0
	void Right(); // Function MeshModelingTools.MirrorToolActionPropertySet.Right // (Final|Native|Public) // @ game+0xe8c080
	void Left(); // Function MeshModelingTools.MirrorToolActionPropertySet.Left // (Final|Native|Public) // @ game+0xe8c060
	void Forward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Forward // (Final|Native|Public) // @ game+0xe8c040
	void Down(); // Function MeshModelingTools.MirrorToolActionPropertySet.Down // (Final|Native|Public) // @ game+0xe8c020
	void Backward(); // Function MeshModelingTools.MirrorToolActionPropertySet.Backward // (Final|Native|Public) // @ game+0xe8bfe0
};
...
struct UPlaneCutTool : UMultiSelectionTool {
	...
	void Cut(); // Function MeshModelingTools.PlaneCutTool.Cut // (Final|Native|Protected) // @ game+0xe8c000
};
...
struct USeamSculptTool : UDynamicMeshBrushTool {
	struct USeamSculptToolProperties* Settings; // 0x200(0x08)
	struct UPreviewGeometry* PreviewGeom; // 0x208(0x08)
	char pad_210[0xd0]; // 0x210(0xd0)
};
